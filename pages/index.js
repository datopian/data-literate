...
export default function Index({ posts }) {
  return (
    <Layout>
      ...
      <p><strong>What?</strong> An experiment in simple, lightweight approach to creating, displaying and sharing datasets and data-driven stories.</p>
      <p><strong>Why?</strong> I want a simple, fast, extensible way to present data(sets) and author data-driven content. I want to work with markdown for content and quickly add data in the simplest way possible e.g. dropping in links, pasting tables or adding links to the metadata.</p>
      <p><strong>How?</strong> Technically the essence is Markdown+React (MDX) + a curated toolkit of components for data-presentation + NextJS for framework and deployment. Check out the <Link href="/demo/"><a>demo</a></Link>, an <Link href="/climate/"><a>example on climate</a></Link> or see more examples below</p>
